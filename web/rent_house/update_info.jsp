...
<html>
    <head>
        <title>Update Rent House INFO Page</title>
    ...
    <body>
        <header class="navbar navbar-expand navbar-dark sticky-top bg-dark flex-md-nowrap p-0 mb-5 shadow">
            ...
            <div class="bg-dark w-100 text-center text-light fw-bold">SỬA THÔNG TIN PHÒNG TRỌ</div>
            ...
            <div class="row">
                <nav aria-label="breadcrumb" class="bg-dark text-light rounded-3 p-3 px-5 mb-4">
                    <ol class="breadcrumb mb-0 fw-bold text-light">
                        ...
                        <li class="breadcrumb-item active text-light" aria-current="page">Chỉnh sửa bài đăng</li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <c:set var="rentHouse" value="${updateRentHouse}" scope="page"></c:set>
                <div class="card">
                    <div class="card-body">
                        <form class="row" action="${root}/user/rent_house" method="post">
                            ...
                            <section class="col-lg-7 col-md-7 col-sm-6 mt-0">
                                ...
                                <div class="btn-group d-flex gap-2">
                                    ...
                                    <button type="submit" name="action" value="${STEP2 == null ? 'update' : 'confirm_update'}"
                                    class="col-8 rounded-3 btn btn-warning border-2 fw-bold">
                                        ${STEP2 == null ? 'Tiếp tục' : 'Xác nhận chỉnh sửa'}
                                    </button>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="staticBackdropLabel">Bạn định hủy</h5>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="${root}/user/rent_house" class="btn btn-primary fw-bold">Xác nhận hủy</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
